...
return
    ...
    [
         ...
         */
        'clientId' => "828948109494-4cbhhe8vfvmddmhpl5o6g7jv25q1dt6o.apps.googleusercontent.com",
         ...
         */
        'serviceEmail' => "828948109494-4cbhhe8vfvmddmhpl5o6g7jv25q1dt6o@developer.gserviceaccount.com",

        /*
         * You need to download a p12-certifciate from the Google API console
         * Be sure to store this file in a secure location.
         */
        'certificatePath' => storage_path('magelaravel-63f51dac10d5.p12'),
